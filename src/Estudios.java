...
public class Estudios implements Comparable <Estudios>{
	//En esta clase se registran estudios hechos sobre el concreto y como su elasticidad disminuye con el tiempo, y varía de acuerdo
	//al tiempo que se dejo antes de poner las cargas
	private int calidadConcreto; 
	private Double[][] modulosElasticidad;
	private int[] intervalosCarga; //Tiempo de espera antes de poner cargas sobre las vigas, el reglamento establece 7, 14 o 28 días
	...
	public Estudios(int calidadConcreto) {
		...
		//Las columnas siempre serán tres, cada factor debe guardar relación con su intervalo de carga
		intervalosCarga[0]=7;
	...
	//Para obtener un factor se realizan dos búsquedas ordenadas en los arreglos de intervalos de tiempo y cargas, obteniendo de estos
