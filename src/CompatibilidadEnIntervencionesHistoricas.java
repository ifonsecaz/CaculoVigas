...
public class CompatibilidadEnIntervencionesHistoricas {
	...
	private ElementosLinealesCubiertas[][] vigas;	//Se optó por crear una matríz de vigas, donde cada renglón representa una sección de vigas
	private int[] modulado; //arreglo paralelo que cuenta las vigas por seccion
	private Estudios[] calidadConcreto;
	private final int ENTRAMADO_DE_VIGAS=15;  //Número máximo de secciones
	private final int NUM_VIGAS=16; //Número máximo de vigas por sección
	private final int TIPOS=6; //Número máximo que el usuario puede declarar de calidades de concreto
	...
	//A través de la obtencion de un factor, se altera la elasticidad de una viga, y por tanto la rigidez y demás valores
	...
	//En los siguientes dos métodos se usó el -1 como una bandera que indica que dicho tipo no tiene ningún estudio,
	...
	public String toString() {
		...
		cad.append("\nPatrimonio Histórico: " + this.nomPatrimonioHistorico);
		cad.append("\nNúmero de calidades de concreto registradas: " + numCalidades);
