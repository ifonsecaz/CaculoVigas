...
public class CompatibilidadVista extends JFrame {
	...
	public CompatibilidadVista(String titulo) {
		...
		String[] cargas= {"7días","14 días", "28 días"};	
		...
		info = new JButton("Información obra");
		info1Viga = new JButton("1Info. Viga");
		infoEstudio = new JButton("2Info. Estudio");
		infoFactor = new JButton("3Info. Factor");
		altaViga = new JButton("5.Alta Viga");
		altaCali= new JButton("4Alta Calidad");
		vigaTiemp = new JButton("Deterioro de la viga");
		reempViga = new JButton("Reemplazar viga");
		bajaEst = new JButton("5Dar de baja estudio");
		bajaViga = new JButton("6Dar de baja viga");
		mayF = new JButton("Factor más grande");
		minF= new JButton("7Factor más pequeño");
