...
public class ElementosLinealesCubiertas implements Comparable <ElementosLinealesCubiertas>{
	...
	public ElementosLinealesCubiertas(int clave) {
		//Constructor realizado para facilitar las búsquedas de un objeto
		this.clave=clave;
	}
	...
	public void setElasticidad(double factor) {
		//Con motivos de que el usuario pueda probar con diferentes factores, se decidió repetir la misma comprobación del constructor
		if(this.calidadConcreto<=200) {
	...
	//Los tres sets siguientes, como se mencionó al inicio, es necesario usar de uno de ellos al inicio del programa para su funcionamiento
	//dependiendo de las necesidades del usuario, puede usar del primero para obtener la rigidez de una viga ya construida, 
	//y de los otros dos para decidir alguna de las dimensiones con las que se constrirá 
	public boolean setRigidez(double claro, double peralte) {
		double r;
		boolean res=false;
		
		//En las normas de construcción, el peralte debe guardar una relación de 1:1 o 3:1 con la base
	...
	//Estos dos set, comprueban que sea la primera vez en asignar los valores, para el primero se decidió no incluirlo para aprovechar el metodo,
	...
	//Este método para calcular la inercia tiene valor solo como comparativa con la de la sección agrietada, pues no considera otros factores externos
