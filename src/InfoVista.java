...
public class InfoVista extends JFrame {
	...
	public InfoVista(String titulo) {
		...
		reMod= new JButton("Relación Modular");
		areaA= new JButton("Área de acero");
		areaAT= new JButton("+Área de acero Transformada");
		ejeN= new JButton("Eje neutro");
		inS= new JButton("*Inercia de la Sección");
		modSec= new JButton("Modulo de Seccón");
